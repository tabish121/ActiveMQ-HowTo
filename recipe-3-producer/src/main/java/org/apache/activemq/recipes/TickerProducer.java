...
public class TickerProducer {
    ...
    public static void main(String[] args) {
        TickerProducer producer = new TickerProducer();
        System.out.print("\n\n\n");
        System.out.println("Starting example Stock Ticker Producer now...");
        try {
            producer.before();
            producer.run();
            producer.after();
        ...
        System.out.println("Finished running the sample Stock Ticker Producer app.");
        System.out.print("\n\n\n");
    }
}